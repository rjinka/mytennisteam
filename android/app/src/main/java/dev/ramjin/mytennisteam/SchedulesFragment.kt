...
import dev.ramjin.mytennisteam.databinding.FragmentSchedulesBinding
    ...
    private fun showCreateOrEditScheduleDialog(schedule: Schedule?) {
        ...
        schedule?.let {
            ...
            it.courts.forEach { scheduleCourt ->
                val courtView = courtsContainer.children.find { view -> view.findViewById<CheckBox>(R.id.court_checkbox).tag == scheduleCourt.courtId }
                courtView?.let {
